...
const methods=['bootstrap','pickRoot','addRoot','removeRoot','refreshRoot','setRootIndexing','rebindPreview','rebindRoot','openQuery','page','position','entry','ancestors','children','freeze','organize','media','release','playback','system','coverSource','coverSnapshot','frame','closeSource','saveCover','recommend','restoreCover','plan','commit','taskAction','plugins','setPlugin','loadPlugin','settings','clearCache','pruneStorage','exportLibrary','importLibrary','switchLibrary','diagnostics'] as const
