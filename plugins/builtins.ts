...
const definitions: [string,string,string,string,PluginSlot][]=[
 ...
 ['viewer-video','Chromium 播放器','内置窗口播放，支持倍速、续播与全屏','查看与播放','viewer.video'],
 ['viewer-mpv','mpv 播放器','内嵌视频播放，支持更多编码、字幕、音轨与进度同步','查看与播放','viewer.video'],
 ['viewer-system','系统默认播放器','使用 Windows 为该视频格式设置的默认应用打开','查看与播放','viewer.video'],
