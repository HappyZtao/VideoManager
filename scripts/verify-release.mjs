...
const files=[`release/VideoManager-${version}-Windows-x64-Setup.exe`,'release/win-unpacked/VideoManager.exe','native/bin/vm-fs.exe','native/bin/vm-media.exe','native/bin/vm-player-host.exe','release/win-unpacked/resources/native/mpv/mpv.exe']
const records=[]
